...
const ContactUs = () => {
  return (
    ...
    <div className='w-full h-[600px] text-center text-white bg-indigo-600/[0.85]  
     flex flex-col items-center justify-center sm:rounded-b-[100px] sm:rounded-t-[100px]'>

     <p className='mb-[30px] md:text-[70px] text-[50px] font-serif font-bold leading-[72px] mt-5'>Join our community</p>
